Here is an attempt to list out some super-useful but not-so-popular websites which offer **images**, **vectors**, **videos**, **music,** **templates** etc for **FREE** with personal & commercial use license.  
